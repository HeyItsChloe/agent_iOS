...
class Settings(BaseSettings):
    ...
    block_agent_git_actions: bool = False  # Block OpenHands from executing git commands
    ...
    def _load_persisted_settings(self) -> None:
        ...
        try:
            ...
            if "block_agent_git_actions" in data:
                self.block_agent_git_actions = data["block_agent_git_actions"]
    ...
    def save_to_disk(self) -> None:
        ...
        data = {
            ...
            "block_agent_git_actions": self.block_agent_git_actions,
        }
