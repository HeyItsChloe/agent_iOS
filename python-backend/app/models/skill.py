...
- Trade-offs to consider""",
    ...
    Skill(
        id="gitlive-sync",
        name="GitLive Sync",
        description="Set up GitLive so user sees your changes in their local VS Code in real-time",
        icon="🔄",
        category=SkillCategory.TOOLS,
        triggers=["gitlive", "vscode", "sync", "live changes", "connect vscode"],
        content="""# GitLive Sync Setup

Set up GitLive so the user can see your changes in their local VS Code in real-time WITHOUT pushing to git.

## Run these commands at conversation start:
